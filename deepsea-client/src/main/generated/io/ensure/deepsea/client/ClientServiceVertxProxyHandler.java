  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "addClient": {
          service.addClient(json.getJsonObject("client") == null ? null : new io.ensure.deepsea.client.Client(json.getJsonObject("client")),
                        res -> {
                        if (res.failed()) {
        ...
        case "retrieveClient": {
          service.retrieveClient((java.lang.String)json.getValue("id"),
                        res -> {
                        if (res.failed()) {
                          if (res.cause() instanceof ServiceException) {
                            msg.reply(res.cause());
        ...
        case "removeClient": {
          service.removeClient(json.getJsonObject("client") == null ? null : new io.ensure.deepsea.client.Client(json.getJsonObject("client")),
