  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "addMenu": {
          service.addMenu(json.getJsonObject("menuItem") == null ? null : new io.ensure.deepsea.ui.menu.MenuItem(json.getJsonObject("menuItem")), res -> {
            if (res.failed()) {
        ...
        case "retrieveMenu": {
          service.retrieveMenu((java.lang.String)json.getValue("id"), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
