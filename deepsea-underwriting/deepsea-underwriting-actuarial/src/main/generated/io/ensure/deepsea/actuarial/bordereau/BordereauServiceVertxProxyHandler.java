    ...
    try {
      ...
      switch (action) {
        ...
        case "retrieveBordereauLine": {
          service.retrieveBordereauLine((java.lang.String)json.getValue("bordereauLineId"), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
        ...
        case "retrieveBordereauByClient": {
          service.retrieveBordereauByClient((java.lang.String)json.getValue("clientId"), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
        ...
        case "retrieveBordereauByClientByPage": {
          service.retrieveBordereauByClientByPage((java.lang.String)json.getValue("clientId"), json.getValue("page") == null ? null : (json.getLong("page").intValue()), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
