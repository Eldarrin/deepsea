...
/**
 @class
*/
export default class BordereauService {
  ...
  retrieveBordereauByClient(clientId: string, resultHandler: (err: any, result: Array<any>) => any) : BordereauService;

  retrieveBordereauByClientByPage(clientId: string, page: number, resultHandler: (err: any, result: Array<any>) => any) : BordereauService;
