...
var JProductService = Java.type('io.ensure.deepsea.shared.product.ProductService');
var Product = Java.type('io.ensure.deepsea.shared.product.Product');
...
var ProductService = function(j_val) {
  ...
  this.addProduct = function(product, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_productService["addProduct(io.ensure.deepsea.shared.product.Product,io.vertx.core.Handler)"](product != null ? new Product(new JsonObject(Java.asJSONCompatible(product))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(null, null);
      } else {
        resultHandler(null, ar.cause());
...
ProductService._jclass = utils.getJavaClass("io.ensure.deepsea.shared.product.ProductService");
