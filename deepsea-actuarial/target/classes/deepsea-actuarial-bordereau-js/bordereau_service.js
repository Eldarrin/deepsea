...
var JBordereauService = Java.type('com.assurant.deepsea.actuarial.bordereau.BordereauService');
var BordereauLine = Java.type('com.assurant.deepsea.actuarial.bordereau.BordereauLine');
...
var BordereauService = function(j_val) {
  ...
  this.addBordereauLine = function(bordereauLine, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_bordereauService["addBordereauLine(com.assurant.deepsea.actuarial.bordereau.BordereauLine,io.vertx.core.Handler)"](bordereauLine != null ? new BordereauLine(new JsonObject(Java.asJSONCompatible(bordereauLine))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(null, null);
      } else {
        resultHandler(null, ar.cause());
...
BordereauService._jclass = utils.getJavaClass("com.assurant.deepsea.actuarial.bordereau.BordereauService");
