...
package io.ensure.deepsea.account.rxjava;
...
import io.ensure.deepsea.account.Account;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.ensure.deepsea.account.AccountService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(io.ensure.deepsea.account.AccountService.class)
public class AccountService {
  ...
  public static final io.vertx.lang.rxjava.TypeArg<AccountService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new AccountService((io.ensure.deepsea.account.AccountService) obj),
    AccountService::getDelegate
  );

  private final io.ensure.deepsea.account.AccountService delegate;
  
  public AccountService(io.ensure.deepsea.account.AccountService delegate) {
    this.delegate = delegate;
  }

  public io.ensure.deepsea.account.AccountService getDelegate() {
    return delegate;
  }
  ...
  public static  AccountService newInstance(io.ensure.deepsea.account.AccountService arg) {
