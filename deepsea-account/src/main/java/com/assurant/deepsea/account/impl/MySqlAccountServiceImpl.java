package io.ensure.deepsea.account.impl;
...
/**
 * MySQL implementation of {@link AccountService}.
 *
 * @author Andy Ward (prev. Eric Zhao)
 */
public class MySqlAccountServiceImpl extends MySqlRepositoryWrapper implements AccountService {

  public MySqlAccountServiceImpl(Vertx vertx, JsonObject config) {
    super(vertx, config);
  }
